...
// 多起点层序遍历，-1时刻原始腐烂橘子。因为正式第一次取出烂剧橘子是0时刻
// 一次遍历，压入0时刻为各个真实腐烂橘子，并统计新鲜橘子数量。
// 注意若无腐烂橘子，特殊情况起始时刻ans=0。
// 对每一层遍历，步数+1。四方拓展。如果遇到新鲜橘子，压入队列+橘子腐烂+新鲜数量减一。
// 最终返回若还有新鲜，则不可能全传染，返回-1，无新鲜，则返回步数ans
