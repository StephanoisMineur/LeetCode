...
// 性质，以最右元素为标杆、最小元素为分割点。
// 最小元素向右元素均小于末尾元素，最小元素之左均大于末尾元素。
// while循环条件，left不必等于right，相等即退出。
// 中点mid元素小于最右元素,说明最小元素在mid之左，right=mid，而不是right-1，考虑[4,1,2]例子
// 中点mid大于最右元素，说明最小元素在mid之右，left=mid+1，考虑[2,3,1]情况，
// left多进一步，left和right相遇退出，返回值即为left
